...
struct DirectoryView: View {
    ...
    /// et y met le focus. Un second tap referme (clavier + barre).
    /// Le texte est conservé : avec une recherche active, la barre reste
    /// visible (comme avant), l'effacement reste dédié à la croix
    /// dans la pastille.
